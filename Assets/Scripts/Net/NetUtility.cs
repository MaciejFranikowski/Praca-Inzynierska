...
{
    // Eventy dla wiadomoœci, C oznacza klient side, S server side
    ...
    public static void OnData(DataStreamReader stream, NetworkConnection cnn, Server server = null)
    {
        ...
        NetMessage msg = null;
        // Odczytany OpCode, od którego zale¿y typ
        ...
        switch (opCode)
        {
            ...
            default:
                Debug.LogError("Otrzymana wiadomoœæ nie mia³a OpCode");
                break;
        }
        // Uruchomienie zdarzeñ dla wiadomoœci
        if (server != null)
        {
